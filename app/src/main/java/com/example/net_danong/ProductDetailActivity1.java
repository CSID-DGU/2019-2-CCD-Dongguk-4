...
import com.google.firebase.firestore.ListenerRegistration;
    ...
    public class ProductDetailActivity1 extends AppCompatActivity /*implements
...
/*
        ...
        private Task<Void> addRating(final DocumentReference restaurantRef, final Review rating) {
...
*
        ...
        private void onRestaurantLoaded(Restaurant restaurant) {
            mNameView.setText(restaurant.getPdtName());
            ...
            mCategoryView.setText(restaurant.getContents());
            mPriceView.setText(ProductUtil.getPriceString(restaurant));
        ...
        @Override
        public void onRating(Review rating) {
